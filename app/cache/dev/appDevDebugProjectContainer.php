...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('fos_user.listener.email_confirmation', 'UserBundle\\EventListener\\EmailConfirmationListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tobook', 'user' => 'root', 'password' => 'Rabbit', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/WCS/ContentBundle/Entity'), 2 => ($this->targetDirs[3].'/src/WCS/PropertyBundle/Entity'), 3 => ($this->targetDirs[3].'/src/WCS/RatingBundle/Entity'), 4 => ($this->targetDirs[3].'/src/WCS/EmailingBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'WCS\\ContentBundle\\Entity');
        $c->addDriver($b, 'WCS\\PropertyBundle\\Entity');
        $c->addDriver($b, 'WCS\\RatingBundle\\Entity');
        $c->addDriver($b, 'WCS\\EmailingBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'WCSContentBundle' => 'WCS\\ContentBundle\\Entity', 'WCSPropertyBundle' => 'WCS\\PropertyBundle\\Entity', 'WCSRatingBundle' => 'WCS\\RatingBundle\\Entity', 'WCSEmailingBundle' => 'WCS\\EmailingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cf98b7139386fa2224d885cb1e8a5042a1579c484bc6893c1c2f860a6e13d51e');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\EmailConfirmationListener A UserBundle\EventListener\EmailConfirmationListener instance
     */
    protected function getFosUser_Listener_EmailConfirmationService()
    {
        return $this->services['fos_user.listener.email_confirmation'] = new \UserBundle\EventListener\EmailConfirmationListener($this->get('fos_user.mailer'), $this->get('fos_user.util.token_generator'), $this->get('router'), $this->get('session'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \WCS\EmailingBundle\Services\ConvertCsvToArray A WCS\EmailingBundle\Services\ConvertCsvToArray instance
     */
    protected function getImport_CsvtoarrayService()
    {
        return $this->services['import.csvtoarray'] = new \WCS\EmailingBundle\Services\ConvertCsvToArray();
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'TobookBundle:Pagination:pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/TobookBundle/Resources/views'), 'Tobook');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/WCS/ContentBundle/Resources/views'), 'WCSContent');
        $instance->addPath(($this->targetDirs[3].'/src/WCS/PropertyBundle/Resources/views'), 'WCSProperty');
        $instance->addPath(($this->targetDirs[3].'/src/WCS/RatingBundle/Resources/views'), 'WCSRating');
        $instance->addPath(($this->targetDirs[3].'/src/WCS/SMSBundle/Resources/views'), 'WCSSMS');
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/src/WCS/EmailingBundle/Resources/views'), 'WCSEmailing');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TobookBundle' => 'TobookBundle\\TobookBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'WCSContentBundle' => 'WCS\\ContentBundle\\WCSContentBundle',
                'WCSPropertyBundle' => 'WCS\\PropertyBundle\\WCSPropertyBundle',
                'WCSRatingBundle' => 'WCS\\RatingBundle\\WCSRatingBundle',
                'WCSSMSBundle' => 'WCS\\SMSBundle\\WCSSMSBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'WCSEmailingBundle' => 'WCS\\EmailingBundle\\WCSEmailingBundle',
            ...
            'locale' => 'fr',
            'csv_directory' => ($this->targetDirs[2].'/../web/uploads/csv'),
            'img_directory' => ($this->targetDirs[2].'/../web/uploads/img/comments'),
            'hotelimg_directory' => ($this->targetDirs[2].'/../web/uploads/img/'),
            ...
            'fos_user.resetting.email.from_email' => array(
                'clubtobook@gmail.com' => 'Reset password',
            ),
            ...
            'knp_paginator.template.pagination' => 'TobookBundle:Pagination:pagination.html.twig',
